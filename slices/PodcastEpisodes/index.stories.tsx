import { UnwrappedPodcastEpisodes } from ".";
import { mockArtworkForPreview, mockEpisode } from "./mockUtils";
...
export const WithHeader = ({ artwork, items, ...props }) => {
  return (
...
export const WithoutHeader = ({ artwork, items, ...props }) => {
  return (
    <UnwrappedPodcastEpisodes
      items={getMockEpisodes(items)}
      artwork={mockArtworkForPreview(artwork)}
...
WithoutHeader.args = {
  showOnlyEpisodes: true,
  showEpisodeArtwork: true,
};

export const WithoutEpisodeArtwork = ({ artwork, items, ...props }) => {
  return (
    <UnwrappedPodcastEpisodes
      items={getMockEpisodes(items)}
      artwork={mockArtworkForPreview(artwork)}
